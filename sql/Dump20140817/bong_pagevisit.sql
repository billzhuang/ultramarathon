...
DROP TABLE IF EXISTS `pagevisit`;
...
CREATE TABLE `pagevisit` (
  ...
  `insertdate` varchar(45) DEFAULT 'now()',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44244 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2014-08-17 22:56:18
